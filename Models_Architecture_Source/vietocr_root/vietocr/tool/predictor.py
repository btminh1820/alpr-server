...
__dir__ = os.path.basename(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))
sys.path.append(__dir__)

from vietocr_root.vietocr.tool.translate import build_model, translate, translate_beam_search, process_input, predict
from vietocr_root.vietocr.tool.utils import download_weights
